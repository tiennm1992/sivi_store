...
$option['col'] = array(
    ...
    5 => array('key_tab' => 'bank_atm', 'title_tab' => 'Ngân hàng - ATM', 'option_tab' => 'sort'),
    6 => array('key_tab' => 'address', 'title_tab' => 'Địa chỉ', 'option_tab' => 'sort'),
    7 => array('key_tab' => 'option', 'title_tab' => 'Quản lý', 'option_tab' => ''),
    8 => array('key_tab' => 'option', 'title_tab' => 'Chỉnh sửa', 'option_tab' => ''),
    9 => array('key_tab' => 'option', 'title_tab' => 'Xóa tài khoản', 'option_tab' => ''),
);
...
<?php foreach ($users as $key => $user): ?>
    <tr>
        ...
        <td><?php echo h($user['User']['phone']); ?>&nbsp;</td>
          <td><?php echo h($user['User']['bank_atm']); ?>&nbsp;</td>
        <td><?php echo h($user['User']['address']); ?>&nbsp;</td>
        <td>
            <a href="/customers/index2/<?php echo h($user['User']['code']); ?>">Khách hàng</a>&nbsp; |
            <a href="/userBuys/index2/<?php echo h($user['User']['code']); ?>">Đơn hàng</a>&nbsp; |
            <a href="/sasi/summary_admin/<?php echo h($user['User']['code']); ?>">Thống kê</a>
        </td>
        <td class="actions">
            <?php
            echo $this->Html->link(
                    $this->Html->tag('i', '', array('class' => 'glyphicon glyphicon-edit icon-white', 'title' => 'Edit')), array('action' => 'edit', $user['User']['id'], 'employee'), array('escape' => false, 'class' => 'btn btn-success btn-sm')
            ) . '&nbsp';
            ?>
        </td>
        <td class="actions">
