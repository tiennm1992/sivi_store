...
//        echo $this->Form->input('role', array('label' => array('text' => 'Tên đăng nhập', 'class' => 'control-label col-xs-12 col-sm-2')));
        ...
        echo $this->Form->input('email', array('label' => array('text' => 'Email', 'class' => 'control-label col-xs-12 col-sm-2')));
        echo $this->Form->input('cmtnd', array('label' => array('text' => 'Chứng minh thư', 'class' => 'control-label col-xs-12 col-sm-2')));
        echo $this->Form->input('bank_atm', array('label' => array('text' => 'Tài khoản ngân hàng', 'class' => 'control-label col-xs-12 col-sm-2')));
        ?>
    </fieldset>
