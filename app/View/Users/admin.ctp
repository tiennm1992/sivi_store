...
$option['col'] = array(
    ...
    6 => array('key_tab' => 'created_datetime', 'title_tab' => 'Ngày tạo', 'option_tab' => 'sort'),
    7 => array('key_tab' => 'option', 'title_tab' => 'Chỉnh sửa', 'option_tab' => ''),
    8 => array('key_tab' => 'option', 'title_tab' => 'Xóa tài khoản', 'option_tab' => ''),
);
...
<?php foreach ($users as $key => $user): ?>
    <tr>
        ...
        <td class="actions">
            <?php
            echo $this->Html->link(
                    $this->Html->tag('i', '', array('class' => 'glyphicon glyphicon-edit icon-white', 'title' => 'Edit')), array('action' => 'edit', $user['User']['id'], 'admin'), array('escape' => false, 'class' => 'btn btn-success btn-sm')
            ) . '&nbsp';
            ?>
        </td>
        <td class="actions">
