...
$option['col'] = array(
    ...
    6 => array('key_tab' => 'option', 'title_tab' => 'Trạng thái đơn hàng', 'option_tab' => ''),
);
...
<?php foreach ($userBuys as $key => $userbuy): ?>
    <tr>
        ...
        <td class="actions">
            <?php
            echo $this->Html->link(
                    $this->Html->tag('i', '', array('class' => 'glyphicon glyphicon-edit icon-white', 'title' => 'approval')), array('action' => 'approval_success', $userbuy['UserBuy']['id']), array('escape' => false, 'class' => 'btn btn-success btn-sm')
            ) . '&nbsp';
//                echo $this->Form->postLink(
//                        $this->Html->tag('i', '', array('class' => 'glyphicon glyphicon-remove icon-white', 'title' => 'Delete')), array('action' => 'delete', $userbuy['UserBuy']['id']), array('escape' => false, 'class' => 'btn btn-danger btn-sm btn-cat-cancel'), __('Bạn có chắc muốn xóa đơn hàng này', $userbuy['UserBuy']['id'])
//                ).'&nbsp';
            ?>
        </td>
    </tr>
